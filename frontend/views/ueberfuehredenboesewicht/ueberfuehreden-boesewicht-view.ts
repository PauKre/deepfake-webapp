    ...
    return html`
        <vaadin-horizontal-layout class="content" style="width: 100%; align-items: flex-start; justify-content: center; height: 100%;">
            ...
            <vaadin-vertical-layout style="align-self: center; align-items: center; justify-content: center; width: 70%; height: 100%; padding: var(--lumo-space-m);">
              ...
              <img id="corruptedImg" style="width: 50%; align-self: center;" src="images/ueberfuehre_den_boesewicht/corrupted.png">
                <vaadin-horizontal-layout theme="spacing" style="flex-grow: 1; flex-shrink: 1; width: 100%; justify-content: center; height: 10%;">
                  ...
                  <img id="taeter1" class="click" style="width: 20%; align-self: flex-start;" src="images/ueberfuehre_den_boesewicht/verdachtiger_1.jpg">
                  <img id="taeter2" class="click" style="width: 20%; align-self: flex-start;" src="images/ueberfuehre_den_boesewicht/verdachtiger_2.jpg">
                  <img id="taeter3" class="click" style="width: 20%; align-self: flex-start;" src="images/ueberfuehre_den_boesewicht/verdachtiger_3.jpg">
                  <img id="taeter4" class="click" style="width: 20%; align-self: flex-start;" src="images/ueberfuehre_den_boesewicht/verdachtiger_4.jpg">
